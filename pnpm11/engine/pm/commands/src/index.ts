...
export { assertPnpmRuns, assertReleaseIsInstallable, exePlatformPkgDirName, exePlatformPkgDirNameNext, installPnpm, installPnpmToStore, isReleaseInstallable, linkExePlatformBinary, pnpmPackageNameToInstall, repairStaleEngineBins } from './self-updater/installPnpm.js'
