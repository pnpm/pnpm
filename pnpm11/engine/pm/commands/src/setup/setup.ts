...
# A chain longer than the cap, or one that changed under us mid-walk, leaves
# $self a symlink, and the directory beside it is then the wrong place to take
# \`pnpm\` from — the substitution this script exists to prevent.
if [ -L "$self" ]; then
