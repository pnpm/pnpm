 ...
 * until the foreground command exits. Without a trap, dash and zsh die from
 * that signal even when the command handled it and exited with a status,
 * which pnpm would report as a lifecycle failure
