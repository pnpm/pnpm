...
import type { installDeps as installDepsFn } from '../../src/installDeps.js'
import { DEFAULT_OPTS } from '../utils/index.js'

const installDeps = jest.fn<typeof installDepsFn>()
const createVulnerabilityUpdateMatching = jest.fn()

jest.unstable_mockModule('../../src/installDeps.js', () => ({
  createVulnerabilityUpdateMatching,
  installDeps,
}))
