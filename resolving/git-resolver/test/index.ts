...
test('resolveFromGit() with commit', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'zkochan/is-negative#163360a8d3ae6bee9524541043197ff356f8ed99',
  })
...
test('resolveFromGit() with no commit', async () => {
  ...
  for (let i = 0; i < 2; i++) {
    ...
    expect(resolveResult).toStrictEqual({
      ...
      resolution: {
        tarball:
          'https://codeload.github.com/zkochan/is-negative/tar.gz/1d7e288222b53a0cab90a331f1865220ec29560c',
      },
      resolvedVia: 'git-repository',
    })
  }
...
test('resolveFromGit() with no commit, when main branch is not master', async () => {
  ...
  expect(resolveResult).toStrictEqual({
    ...
    resolution: {
      tarball:
        'https://codeload.github.com/zoli-forks/cmd-shim/tar.gz/a00a83a1593edb6e395d3ce41f2ef70edf7e2cf5',
    },
    resolvedVia: 'git-repository',
  })
})
...
test('resolveFromGit() with partial commit', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'zoli-forks/cmd-shim#a00a83a',
  })
  expect(resolveResult).toStrictEqual({
...
test('resolveFromGit() with branch', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'zkochan/is-negative#canary',
  })
  expect(resolveResult).toStrictEqual({
    ...
    resolution: {
      tarball:
        'https://codeload.github.com/zkochan/is-negative/tar.gz/4c39fbc124cd4944ee51cb082ad49320fab58121',
    },
    resolvedVia: 'git-repository',
  })
})
...
test('resolveFromGit() with branch relative to refs', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'zkochan/is-negative#heads/canary',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/zkochan/is-negative/4c39fbc124cd4944ee51cb082ad49320fab58121',
...
test('resolveFromGit() with tag', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'zkochan/is-negative#2.0.1',
  })
  expect(resolveResult).toStrictEqual({
...
test.skip('resolveFromGit() with tag (v-prefixed tag)', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'andreineculau/npm-publish-git#v0.0.7',
  })
  expect(resolveResult).toStrictEqual({
    ...
    resolution: {
      tarball:
        'https://codeload.github.com/andreineculau/npm-publish-git/tar.gz/a2f8d94562884e9529cb12c0818312ac87ab7f0b',
    },
    resolvedVia: 'git-repository',
  })
})
...
test('resolveFromGit() with strict semver', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'zkochan/is-negative#semver:1.0.0',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/zkochan/is-negative/163360a8d3ae6bee9524541043197ff356f8ed99',
...
test.skip('resolveFromGit() with strict semver (v-prefixed tag)', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'andreineculau/npm-publish-git#semver:v0.0.7',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/andreineculau/npm-publish-git/a2f8d94562884e9529cb12c0818312ac87ab7f0b',
...
test('resolveFromGit() with range semver', async () => {
  ...
  expect(resolveResult).toStrictEqual({
    ...
    resolution: {
      tarball:
        'https://codeload.github.com/zkochan/is-negative/tar.gz/9a89df745b2ec20ae7445d3d9853ceaeef5b0b72',
    },
    resolvedVia: 'git-repository',
  })
})
...
test('resolveFromGit() fails when ref not found', async () => {
  await expect(
    ...
    /Could not resolve bad-ref to a commit of (https|git):\/\/github.com\/zkochan\/is-negative.git./
  )
})
...
test('resolveFromGit() fails when semver ref not found', async () => {
  await expect(
    ...
    /Could not resolve \^100.0.0 to a commit of (https|git):\/\/github.com\/zkochan\/is-negative.git. Available versions are: 1.0.0, 1.0.1, 2.0.0, 2.0.1, 2.0.2, 2.1.0/
  )
})
...
test('resolveFromGit() with commit from non-github repo', async () => {
  ...
  const resolveResult = await resolveFromGit({
    pref: `git+file://${localPath}#988c61e11dc8d9ca0b5580cb15291951812549dc`,
  })
  expect(resolveResult).toStrictEqual({
...
test.skip('resolveFromGit() bitbucket with commit', async () => {
  ...
  const resolveResult = await resolveFromGit({
    pref: 'bitbucket:pnpmjs/git-resolver#988c61e11dc8d9ca0b5580cb15291951812549dc',
  })
  expect(resolveResult).toStrictEqual({
    id: 'bitbucket.org/pnpmjs/git-resolver/988c61e11dc8d9ca0b5580cb15291951812549dc',
    normalizedPref:
      'bitbucket:pnpmjs/git-resolver#988c61e11dc8d9ca0b5580cb15291951812549dc',
    resolution: {
      tarball:
        'https://bitbucket.org/pnpmjs/git-resolver/get/988c61e11dc8d9ca0b5580cb15291951812549dc.tar.gz',
    },
    resolvedVia: 'git-repository',
  })
})
...
test.skip('resolveFromGit() bitbucket with no commit', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'bitbucket:pnpmjs/git-resolver',
  })
  const result = await git(
    [
      'ls-remote',
      '--refs',
      'https://bitbucket.org/pnpmjs/git-resolver.git',
      'master',
    ],
    { retries: 0 }
  )
...
test.skip('resolveFromGit() bitbucket with branch', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'bitbucket:pnpmjs/git-resolver#master',
  })
  const result = await git(
    [
      'ls-remote',
...
test.skip('resolveFromGit() bitbucket with tag', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'bitbucket:pnpmjs/git-resolver#0.3.4',
  })
  expect(resolveResult).toStrictEqual({
...
test.skip('resolveFromGit() gitlab with tag', async () => {
  ...
  expect(resolveResult).toStrictEqual({
    ...
    resolution: {
      tarball:
        'https://gitlab.com/api/v4/projects/pnpm%2Fgit-resolver/repository/archive.tar.gz?ref=87cf6a67064d2ce56e8cd20624769a5512b83ff9',
    },
    resolvedVia: 'git-repository',
  })
})
...
test('resolveFromGit() normalizes full url', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'git+ssh://git@github.com:zkochan/is-negative.git#2.0.1',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/zkochan/is-negative/2fa0531ab04e300a24ef4fd7fb3a280eccb7ccc5',
    normalizedPref: 'github:zkochan/is-negative#2.0.1',
...
test('resolveFromGit() normalizes full url with port', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'git+ssh://git@github.com:22:zkochan/is-negative.git#2.0.1',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/zkochan/is-negative/2fa0531ab04e300a24ef4fd7fb3a280eccb7ccc5',
    normalizedPref: 'github:zkochan/is-negative#2.0.1',
...
test('resolveFromGit() normalizes full url (alternative form 2)', async () => {
  const resolveResult = await resolveFromGit({
    pref: 'https://github.com/zkochan/is-negative.git#2.0.1',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/zkochan/is-negative/2fa0531ab04e300a24ef4fd7fb3a280eccb7ccc5',
    normalizedPref: 'github:zkochan/is-negative#2.0.1',
...
test('resolveFromGit() private repo with commit hash', async () => {
  mockFetchAsPrivate()
  const resolveResult = await resolveFromGit({
    pref: 'fake/private-repo#2fa0531ab04e300a24ef4fd7fb3a280eccb7ccc5',
  })
  expect(resolveResult).toStrictEqual({
    id: 'github.com/fake/private-repo/2fa0531ab04e300a24ef4fd7fb3a280eccb7ccc5',
    normalizedPref:
      'github:fake/private-repo#2fa0531ab04e300a24ef4fd7fb3a280eccb7ccc5',
    resolution: {
...
test('resolve a private repository using the HTTPS protocol without auth token', async () => {
  ...
  mockFetchAsPrivate()
  const resolveResult = await resolveFromGit({
    pref: 'git+https://github.com/foo/bar.git',
  })
  expect(resolveResult).toStrictEqual({
...
',
  ...
  mockFetchAsPrivate()
  const resolveResult = await resolveFromGit({
    pref: 'git+https://0000000000000000000000000000000000000000:x-oauth-basic@github.com/foo/bar.git',
  })
  expect(resolveResult).toStrictEqual({
...
test('resolve an internal repository using SSH protocol with range semver', async () => {
  git.mockImplementation(async (args: string[]) => {
    if (!args.includes('ssh://git@example.com/org/repo.git'))
      throw new Error('')
    if (args.includes('--refs')) {
      return {
        stdout:
...
cba04669e621b85fbdb33371604de1a2898e68e9\trefs/tags/v0.0.39',
  ...
  const resolveResult = await resolveFromGit({
    pref: 'git+ssh://git@example.com/org/repo.git#semver:~0.0.38',
  })
  expect(resolveResult).toStrictEqual({
