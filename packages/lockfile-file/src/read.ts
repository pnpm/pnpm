...
async function _read (
  ...
  if (lockfile) {
    ...
    if (typeof opts.wantedVersion !== 'string' || semver.major(lockfileSemver) === semver.major(comverToSemver(opts.wantedVersion))) {
      if (typeof opts.wantedVersion === 'string' && semver.gt(lockfileSemver, comverToSemver(opts.wantedVersion))) {
        logger.warn({
