...
export default async (workspaceRoot: string): Promise<Array<{path: string, manifest: DependencyPackageJson}>> => {
...
export function arrayOfLocalPackagesToMap (
  pkgs: Array<{path: string, manifest: DependencyPackageJson}>,
) {
