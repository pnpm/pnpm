...
export async function getConfig (
  ...
  if (pnpmConfig.rootProjectManifest?.workspaces?.length && !pnpmConfig.workspaceDir) {
    warnings.push('The "workspaces" field in package.json is ignored by pnpm unless you create an empty "pnpm-workspace.yaml" file in the root of your monorepo.')
  }
