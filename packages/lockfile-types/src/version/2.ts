...
export const lockfileVersion = 2;
...
export interface PackageSnapshots {
  [packagePath: string]: string | PackageSnapshot // string = resolution integrity
}
...
export interface PackageSnapshot {
  ...
  name?: string
  version?: string
  resolution: string // 40 char hex = sha1sum. example: d71c96f7d41d0feda2c38cd14e8a27c04158df4a
  dependencies?: ResolvedDependencies
  optionalDependencies?: ResolvedDependencies
  peerDependencies?: {
    [name: string]: string
