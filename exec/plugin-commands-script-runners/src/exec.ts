...
export async function handler (
  ...
  } & Pick<Config, 'rawConfig' | 'bin' | 'pnpmHomeDir' | 'extraBinPaths' | 'extraEnv' | 'lockfileDir' | 'modulesDir' | 'dir' | 'userAgent' | 'recursive' | 'reporterHidePrefix' | 'workspaceDir' | 'nodeOptions'>,
  params: string[]
