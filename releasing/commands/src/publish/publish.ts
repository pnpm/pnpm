    ...
    descriptionLists: [
      {
        ...
        list: [
          ...
          {
            description: 'Preserve the original packageManager field and publish lifecycle scripts in the published manifest instead of stripping them. The pnpm-specific "pnpm" field is still omitted.',
