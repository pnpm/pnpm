...
test('tarball from npm registry', async () => {
  ...
  expect(manifest.dependencies).toStrictEqual({
    'is-array': `http://localhost:${REGISTRY_MOCK_PORT}/is-array/-/is-array-1.0.1.tgz`,
  })
})
...
test('tarballs from GitHub (is-negative)', async () => {
  ...
  await addDependenciesToPackage(
    {},
    [
      'is-negative@https://github.com/kevva/is-negative/archive/1d7e288222b53a0cab90a331f1865220ec29560c.tar.gz',
    ],
    await testDefaults()
  )
