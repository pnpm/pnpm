...
test('recursive update', async () => {
  ...
  expect(
    projects['project-1'].requireModule('is-positive/package.json').version
  ).toBe('2.0.0')
...
test('recursive update with pattern', async () => {
  ...
  expect(
    projects['project-1'].requireModule(
      '@pnpm.e2e/dep-of-pkg-with-1-dep/package.json'
    ).version
  ).toBe('100.1.0')
  expect(
    projects['project-1'].requireModule('@pnpm.e2e/foo/package.json').version
  ).toBe('1.0.0')
  expect(
    projects['project-2'].requireModule('@pnpm.e2e/peer-c/package.json').version
  ).toBe('2.0.0')
})
...
test('recursive update with pattern and name in project', async () => {
  ...
  await addDistTag({
    package: '@pnpm.e2e/print-version',
    version: '2.0.0',
    distTag: 'latest',
  })
  ...
  expect(
    projects['project-2'].requireModule('@pnpm.e2e/print-version/package.json')
      .version
  ).toBe('2.0.0')
})
