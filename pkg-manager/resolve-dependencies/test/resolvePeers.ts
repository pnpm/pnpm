...
describe('peer dependency issues', () => {
  ...
  it('should find peer dependency conflicts', () => {
    expect(peerDependencyIssuesByProjects.project3.conflicts).toStrictEqual([
      'peer',
    ])
  })
  ...
  it('should pick the single wanted peer dependency range', () => {
    expect(peerDependencyIssuesByProjects.project1.intersections).toStrictEqual(
      { peer: '1' }
    )
    expect(peerDependencyIssuesByProjects.project2.intersections).toStrictEqual(
      { peer: '2' }
    )
  })
  it('should return the intersection of two compatible ranges', () => {
    expect(peerDependencyIssuesByProjects.project4.intersections).toStrictEqual(
      { peer: '>=2.2.0 <3.0.0-0' }
    )
  })
})
...
describe('unmet peer dependency issues', () => {
  ...
  it('should not warn when the found package has prerelease version and the wanted range is *', () => {
    expect(peerDependencyIssuesByProjects).not.toHaveProperty([
      'project1',
      'bad',
      'peer1',
    ])
...
describe('unmet peer dependency issue resolved from subdependency', () => {
  ...
  it('should return from where the bad peer dependency is resolved', () => {
    expect(
      peerDependencyIssuesByProjects.project.bad.dep[0].resolvedFrom
