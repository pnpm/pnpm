...
export async function prune(
        ...
        await Promise.all(
          Array.from(depsToRemove).map(async (depName) => {
            ...
            return removeDirectDependency(
              {
                dependenciesField:
                  (currentImporter.devDependencies?.[depName] != null &&
                    'devDependencies') ||
                  (currentImporter.optionalDependencies?.[depName] != null &&
                    'optionalDependencies') ||
                  (currentImporter.dependencies?.[depName] != null &&
                    'dependencies') ||
                  undefined,
                name: depName,
              },
  ...
  const currentPkgIdsByDepPaths = equals(
    selectedImporterIds,
...
function mergeDependencies(projectSnapshot: ProjectSnapshot): {
