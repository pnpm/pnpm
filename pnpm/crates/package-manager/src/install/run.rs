    ...
    DependencyGroupList: IntoIterator<Item = DependencyGroup>,
{
    ...
    async fn run_inner_impl<Reporter: self::Reporter + 'static>(
        ...
        let materialized = materialize::<Reporter>(MaterializationInputs {
            ...
            resolved_packages: install.resolved_packages,
            ...
            persist_policy_excludes: install.persist_policy_excludes,
...
struct InstallView<'a> {
    resolved_packages: &'a super::ResolvedPackages,
    http_client: &'a super::ThrottledClient,
    config: &'static Config,
    manifest: &'a PackageManifest,
    emit_initial_manifest: bool,
