...
fn from_save_options_matches_pnpm_get_range_spec_style() {
    assert_eq!(
        RangeSpecStyle::from_save_options(true, None),
...
fn from_save_options_default_and_precedence() {
    assert_eq!(
        RangeSpecStyle::from_save_options(false, None),
        RangeSpecStyle::Major,
    );
    assert_eq!(RangeSpecStyle::default(), RangeSpecStyle::Major);
    assert_eq!(
        RangeSpecStyle::from_save_options(true, Some("~")),
        RangeSpecStyle::Patch,
    );
    assert_eq!(
        RangeSpecStyle::from_save_options(true, Some("^")),
...
fn granularity_collapses_exact_to_patch() {
    assert_eq!(
        RangeSpecStyle::Major.granularity(),
        RangeSpecGranularity::Major,
    );
    assert_eq!(
        RangeSpecStyle::Minor.granularity(),
        RangeSpecGranularity::Minor,
    );
    assert_eq!(
        RangeSpecStyle::Patch.granularity(),
        RangeSpecGranularity::Patch,
    );
    assert_eq!(
        RangeSpecStyle::Exact.granularity(),
        RangeSpecGranularity::Patch,
    );
    assert_eq!(
        RangeSpecStyle::None.granularity(),
        RangeSpecGranularity::None,
    );
}
