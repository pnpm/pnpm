...
/// Version 1.1.0 of the fixture ships an executable file. Windows cannot
/// record the execute bit when it rehashes the built package, which must
/// not make the side-effects row look non-empty.
///
