...
///
/// Declining the shape on the way in is only half of it: a protocol-less
/// path re-anchored onto a Windows drive would put the ambiguity back,
/// so [`without_protocol`] gives that form a protocol.
