...
pub(crate) fn resolve_version_references(
    ...
    root_dir: &Path,
    preferred_manifest_format: Option<crate::ManifestFormat>,
    ...
    let root_manifest = match PackageManifest::from_path(
        pnpm_package_manifest::project_manifest_path(root_dir, preferred_manifest_format),
    ) {
