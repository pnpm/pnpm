...
pub const TARBALL_REVISION_MISMATCH_VIOLATION_CODE: &str = "TARBALL_REVISION_MISMATCH";
pub const MISSING_TARBALL_INTEGRITY_VIOLATION_CODE: &str = "MISSING_TARBALL_INTEGRITY";
pub const MISSING_NAMED_REGISTRY_VIOLATION_CODE: &str = "MISSING_NAMED_REGISTRY";
