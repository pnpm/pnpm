...
fn pick_respecting_min_release_age(
    ...
    run_picker(picker_opts, spec, |target_spec| {
        ...
        // Fall back to lowest regardless of maturity so the install layer can
        // flag the violation; preserve highest.latest so the reporter doesn't
        // advertise an immature version.
