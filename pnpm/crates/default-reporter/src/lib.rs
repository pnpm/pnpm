...
use pnpm_reporter::{FetchingProgressMessage, LogEvent, Reporter};
...
impl TerminalViewport {
    fn new(columns: usize, rows: Option<usize>) -> Self {
        Self {
            columns,
            rows,
            committed_lines: 0,
...
fn lifecycle_options() -> state::LifecycleOptions {
