...
auto-install-peers=false`,
  ...
  expect(
    loadJsonFile<Manifest>('project-1/package.json').dependencies?.[
      '@pnpm.e2e/abc-grand-parent-with-c'
    ]
  ).toBe('^1.0.0')
  expect(
    loadJsonFile<Manifest>('project-2/package.json').dependencies?.[
      '@pnpm.e2e/abc-grand-parent-with-c'
    ]
  ).toBe('^1.0.1')
})
...
auto-install-peers=true`,
  ...
  expect(
    ...
    '1.0.0(@pnpm.e2e/peer-a@1.0.0)(@pnpm.e2e/peer-b@1.0.0)(@pnpm.e2e/peer-c@1.0.0)'
  )
})
