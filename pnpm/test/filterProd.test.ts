...
test.each([
  {
    message: '--filter should include devDependencies',
    filter: '--filter',
    expected: ['project-1', 'project-3', 'project-4'],
  },
  {
    message: '--filter-prod should not include devDependencies',
    filter: '--filter-prod',
    expected: ['project-1', 'project-3'],
  },
