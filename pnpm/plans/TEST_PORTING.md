...
- [x] `TypeScript repo: installing/commands/test/update/jsr.ts:91` `jsr with alias` — ported as a `known_failures` case: pacquet resolves an aliased `jsr:` dependency but leaves the lockfile importer empty (pnpm/pnpm#13362).
