...
use pacquet_resolving_npm_resolver::{
    CreateNpmResolutionVerifierOptions, ObservedUnpackedSizes, PackageMetaCache,
...
///
/// `observed_unpacked_sizes` is the optional
/// [`ObservedUnpackedSizes`] sink the npm verifier fills with each
/// verified entry's `dist.unpackedSize`; pass `None` when the caller
/// has no use for the sizes.
