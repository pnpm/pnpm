...
export type OverrideSource = Readonly<Pick<Config, CliOptionName>>
export type OverrideTarget = Pick<Config, 'supportedArchitectures'>
 ...
 */
export function overrideSupportedArchitecturesWithCLI (config: OverrideSource & OverrideTarget): void {
