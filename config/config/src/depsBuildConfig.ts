...
export const hasDepsBuild = (config: Config): boolean => DEPS_BUILD_CONFIG_KEYS.some(key => config[key] != null)
 ...
 */
export function removeDepsBuild (targetConfig: Config): DepsBuildConfig {
