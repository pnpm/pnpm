...
test('rebuilds dependencies', async () => {
    ...
    const cacheIntegrity = storeIndex1.get(cacheIntegrityPath);
...
test('skipIfHasSideEffectsCache', async () => {
    ...
    let cacheIntegrity = storeIndex.get(cacheIntegrityPath);
    ...
    expect(modules).toBeTruthy();
    expect(modules.pendingBuilds).toHaveLength(0);
    cacheIntegrity = storeIndex.get(cacheIntegrityPath);
    expect(cacheIntegrity.sideEffects).toBeTruthy();
