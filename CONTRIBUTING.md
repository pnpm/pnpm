...
2. Change any source code file and run `node <repo_directory>/packages/pnpm/pnpm [command] [flags]` to run `pnpm` directly from the source code by compiling all the files without typechecking in memory.
