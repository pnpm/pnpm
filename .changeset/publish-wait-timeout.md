...
Recursive publishing confirms availability before publishing dependent packages. If confirmation times out, the command fails and `--report-summary` keeps the packages whose uploads were accepted.
